...
if ( ! class_exists( 'Psea_elementor_init' ) ){
final class Psea_elementor_init {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'psea' ),
			'<strong>' . esc_html__( 'Post Slider', 'psea' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'psea' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'psea' ),
			'<strong>' . esc_html__( 'Post Slider Addon', 'psea' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'psea' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'psea' ),
			'<strong>' . esc_html__( 'Post Slider', 'psea' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'psea' ) . '</strong>',
